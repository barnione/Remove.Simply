import { bm as noop, b2 as isBezierDefinition, cA as invariant, bp as mixNumber$1, cW as rgba, cz as hsla, cy as hex, cE as isCSSVariableToken, cc as color, cd as complex, c7 as analyseComplexValue, bv as frameData, bt as time, b7 as cancelFrame, b6 as frame, bE as millisecondsToSeconds, aZ as clamp, ct as generateLinearEasing, bh as secondsToMilliseconds, bL as velocityPerSecond, bX as MotionGlobalConfig, db as WithPromise, cx as getFinalKeyframe, a_ as NativeAnimation, c$ as setStyle, bT as isGenerator, bP as acceleratedValues, b3 as memo, c1 as KeyframeResolver, cs as flushKeyframeResolvers, cT as resolveTransition, ba as transformProps, cH as isNumericalString, cU as resolveVariantFromProps, b9 as transformPropOrder, a$ as motionValue, bf as isMotionValue, cO as optimizedAppearDataAttribute, cM as isZeroValueString, cu as getAnimatableNone, cq as findDimensionValueType, ce as containsCSSVariable, dc as positionalValues, dd as isNumOrPxType, bb as isHTMLElement, bn as VisualElement, cl as defaultTransformValue, cS as readTransformValue, cD as isCSSVariableName, c8 as buildHTMLStyles, cY as scrapeMotionValuesFromProps, b8 as camelToDash, bo as createBox, cv as getDefaultValueType, cZ as scrapeMotionValuesFromProps$1, c9 as buildSVGAttrs, cI as isSVGTag, d7 as variantProps, cK as isVariantLabel, cB as isAnimationControls, d6 as variantPriorityOrder, de as isSVGComponent, r as reactExports } from "./Providers-WL0Y5vQ8.js";
...
function animateTarget(visualElement, targetAndTransition, { delay = 0, transitionOverride, type } = {}) {
  ...
  if (path) {
    path.animateVisualElement(visualElement, target, transition, delay, animations2);
  }
  for (const key in target) {
...
export {
  backIn as $,
  addValueToWillChange as A,
  isElementTextInput as B,
  animations as C,
  gestureAnimations as D,
  createDomVisualElement as E,
  Feature as F,
  domAnimation as G,
  HTMLVisualElement as H,
  defaultOffset as I,
  JSAnimation as J,
  animateVisualElement as K,
  setTarget as L,
  createGeneratorEasing as M,
  fillOffset as N,
  reverseEasing as O,
  animateTarget as P,
  spring as Q,
  AsyncMotionValueAnimation as R,
  SVGVisualElement as S,
  DOMKeyframesResolver as T,
  DOMVisualElement as U,
  NativeAnimationExtended as V,
  animateValue as W,
  animateVariant as X,
  anticipate as Y,
  applyAxisDelta as Z,
  applyPointDelta as _,
  animateMotionValue as a,
  backInOut as a0,
  backOut as a1,
  calcChildStagger as a2,
  calcGeneratorDuration as a3,
  camelCaseAttributes as a4,
  checkVariantsDidChange as a5,
  circIn as a6,
  circInOut as a7,
  convertOffsetToTimes as a8,
  createAnimationState as a9,
  mixColor as aA,
  mixComplex as aB,
  mixImmediate as aC,
  mixLinearColor as aD,
  mixObject as aE,
  mixVisibility as aF,
  parseCSSVariable as aG,
  positionalKeys as aH,
  press as aI,
  renderHTML as aJ,
  renderSVG as aK,
  resolveVariant as aL,
  supportsBrowserAnimation as aM,
  transformAxis as aN,
  transformBoxPoints as aO,
  cubicBezier as aa,
  defaultEasing as ab,
  easeIn as ac,
  easeInOut as ad,
  easeOut as ae,
  getDefaultTransition as af,
  getMixer as ag,
  getVariableValue as ah,
  getVariantContext as ai,
  hover as aj,
  hslaToRgba as ak,
  inertia as al,
  invisibleValues as am,
  isDragActive as an,
  isElementKeyboardAccessible as ao,
  isKeyframesTarget as ap,
  isNodeOrChild as aq,
  isTransitionDefined as ar,
  isWillChangeMotionValue as as,
  keyframes as at,
  makeAnimationInstant as au,
  maxGeneratorDuration as av,
  measureViewportBox as aw,
  mirrorEasing as ax,
  mix as ay,
  mixArray as az,
  isDragging as b,
  ...
  applyBoxDelta as k,
  has2DTranslate as l,
  applyTreeDeltas as m,
  getOptimisedAppearId as n,
  addDomEvent as o,
  progress as p,
  addPointerInfo as q,
  ...
  extractEventInfo as v,
  pipe as w,
  measurePageBox as x,
  convertBoxToBoundingBox as y,
  convertBoundingBoxToBox as z
};
