...
Remove.Simply/
├── package.json
├── electron.vite.config.ts        # 3 renderer HTML entries + main + preload
├── electron-builder.yml
├── build/                         # packaging assets (generated from the brand files below)
│   ├── icon.icns                  # macOS — compiled from icon-removesimply.icon/
│   ├── icon.ico                   # Windows — generated from windowsicon-removesimply.png
